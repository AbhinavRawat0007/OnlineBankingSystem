...
show tables;
select * from signup ;
create table signup2(formno varchar(20),religon varchar(20), category varchar(20),income varchar(20),Education varchar(20),Occupation varchar(30),PAN varchar(20),Aadhar varchar(40),SeniorCitizen varchar(25),ExistingAccount varchar(20));
show tables;
select * from signup2 ;
